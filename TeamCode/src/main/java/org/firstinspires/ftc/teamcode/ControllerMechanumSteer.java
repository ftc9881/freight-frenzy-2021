...
public class ControllerMechanumSteer extends Controller implements ControllerIF {
    static final String CLASS_NAME = "ControllerMechanumSteer";
    private Movement _movement = new Movement(0, 0, 0);

    public ControllerMechanumSteer(OpMode opMode, String name) {
        super(opMode, name);
    }
